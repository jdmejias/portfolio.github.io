        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                type="Featured Project – Influencer Marketing Platform"
                title="AdsInfluencers"
                summary="A platform that connects businesses with influencers. Influencers can market their products, and companies can search for the best-fitting influencers for their campaigns and hire them directly."
                img={proj1}
                link="https://adsinfluencers.com/"
                github="https://github.com/jdmejias"
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
                type="Featured Project – Agricultural Investment Platform"
                title="De Origen"
