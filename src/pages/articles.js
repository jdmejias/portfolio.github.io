      ...
      >
        <Layout className="pt-16">
          ...
          <ul className="grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16">
            <FeaturedArticle
              img={blog1}
              title="The Future of Machine Learning in Business Strategy"
              time="9 min read"
              summary="Discover how organizations are leveraging machine learning to gain a competitive edge, optimize operations, and create tangible value from their data."
              link="#"
            />

            <FeaturedArticle
              img={blog2}
              title="Building Scalable Data Pipelines with Cloud Computing"
              time="10 min read"
              summary="Learn best practices for deploying robust data architectures on AWS. Explore how cloud computing accelerates data analytics and machine learning workloads."
              link="#"
            />
          </ul>
          ...
          <ul className="flex flex-col items-center relative">
            <Article
              title="Demystifying Neural Networks: A Guide for Business Leaders"
              img={blog3}
            ...
            />
            <Article
              title="Visualizing Data Effectively with Python and Pandas"
              img={blog5}
              date="December 05, 2023"
              link="#"
            />
            <Article
              title="Deploying Scikit-Learn Models to Production via REST APIs"
              img={blog6}
              date="January 10, 2024"
              link="#"
            />
            <Article
              title="A Beginner's Guide to Supervised vs Unsupervised Learning"
              img={blog7}
