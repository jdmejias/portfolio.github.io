    ...
    ">
      ...
      >
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mr-3"
          href="https://x.com/jdmejias_?s=11"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://github.com/jdmejias"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/jhon-deiby-mejias-6a5a60208/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.instagram.com/jdmejias_?igsh=MTlzOGJxejB5NXFvcw%3D%3D&utm_source=qr"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
